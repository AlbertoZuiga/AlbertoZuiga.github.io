      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-8">
          <p className="text-base sm:text-lg mb-4 sm:mb-6">
            &copy; {currentYear} Alberto Zúñiga. Todos los derechos
            reservados.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-transparent border-2 border-white rounded-full text-white text-sm sm:text-base hover:bg-white hover:text-gray-800 transition-all duration-300 transform hover:scale-105"
          >
